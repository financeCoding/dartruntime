...
macro(t_makeExecutable)
    ...
    list(APPEND t_libraries dart_builtin dart_api dart_lib dart_vm jscre double_conversion)
    if(UNIX)
        target_link_libraries(${t_name} -Wl,--start-group ${t_libraries} -Wl,--end-group -lpthread -lrt -lcrypto)
    endif()
endmacro()
...
macro(createSnapshotFile _var _in _exe_name)
    ...
    set(_exe ${EXECUTABLE_OUTPUT_PATH}/${_exe_name})
    add_custom_command(
        OUTPUT ${_out}
        COMMAND ${PYTHON_EXECUTABLE}
